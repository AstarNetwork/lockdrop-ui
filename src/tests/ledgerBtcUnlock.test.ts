...
// this JS library is only used for testing, so we ignore types
// @ts-ignore
...
describe('Test HID connection with Ledger from node', () => {
    it('btc.getWalletPublicKey', async () => {
        ...
        const transport: Transport<string> = await Transport.open();
    ...
    it('btc 4', async () => {
        ...
        const btc = new AppBtc(transport);
        const result = await btc.signMessageNew("44'/0'/0'/0", Buffer.from('test').toString('hex'));
    ...
    it('btc seg multi', async () => {
        ...
        const result = await btc.createPaymentTransactionNew({
            ...
            changePath: undefined,
            outputScriptHex: '01ecd3e7020000000017a9142397c9bb7a3b8a08368a72b3e58c7bb85055579287',
            lockTime: undefined,
...
*/
    it('btc sign p2sh seg', async () => {
        ...
        const result = await btc.signP2SHTransaction({
            ...
            associatedKeysets: ["0'/0/0"],
            outputScriptHex: '0188130000000000001976a9140ae1441568d0d293764a347b191025c51556cecd88ac',
            segwit: true,
        });
    ...
    it('signMessage', async () => {
        ...
        const res = await btc.signMessageNew("44'/0'/0'/0/0", Buffer.from('foobar').toString('hex'));
