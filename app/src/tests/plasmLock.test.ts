...
const sampleLock = new Struct(
    ...
    },
    {
        ...
        publicKey: new U8aFixed(registry, '0x039360c9cbbede9ee771a55581d4a53cbcc4640953169549993a3b0e6ec7984061', 33*8),
...
describe('real-time lockdrop claim hash tests', () => {
    it('checks claim request hashing', () => {
        expect(sampleLock.hash == sampleClaimId).toEqual(true);
    });
